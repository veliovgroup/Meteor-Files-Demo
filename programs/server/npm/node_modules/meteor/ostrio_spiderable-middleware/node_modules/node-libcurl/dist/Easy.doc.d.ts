 ...
 */
/**
 * This file is needed just for documentation purposes
 * There is no easy way to use api-documented with the way the classes are defined
 *  on this lib.
 */
import { CurlCode } from './enum/CurlCode';
import { DataCallbackOptions, ProgressCallbackOptions, StringListOptions, SpecificOptions, CurlOptionName } from './generated/CurlOption';
import { FileInfo, HttpPostField } from './types';
import { Share } from './Share';
import { CurlGssApi } from './enum/CurlGssApi';
import { CurlSslOpt } from './enum/CurlSslOpt';
import { GetInfoReturn } from './types/EasyNativeBinding';
...
declare class Easy {
     ...
     * Official libcurl documentation: [curl_easy_setopt()](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'DEBUGFUNCTION', value: ((type: number, data: Buffer) => void) | null): CurlCode;
    /**
     * Use `Curl.option` for predefined constants.
     *
     * Official libcurl documentation: [curl_easy_setopt()](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
...
export { Easy };
//# sourceMappingURL=Easy.doc.d.ts.map