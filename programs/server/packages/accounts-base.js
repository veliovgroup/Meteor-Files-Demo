...
function expirePasswordToken(accounts, oldestValidDate, tokenFilter, userId) {
  ...
  accounts.users.update(_extends({}, userFilter, expireFilter), {
    $unset: {
